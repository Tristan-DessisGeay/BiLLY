...
import '../data_processing/user.dart';
import '../firebase_functions/auth_functions.dart';
    ...
    title: Center(
      child: Column(
        children: [
          ...
          if(label_connected_user!='') Text(
            label_connected_user,
            style: TextStyle(
              fontSize: (MediaQuery.of(context).size.width>300)?15:10,
              color: Colors.white
            )
          )
        ],
